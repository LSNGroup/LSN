...
int eloop_init(void *user_data)
{
	...
	eloop.num_handles = 1;
	eloop.handles = (HANDLE *)os_malloc(eloop.num_handles *
...
static int eloop_prepare_handles(void)
{
	...
	if (eloop.num_handles > eloop.reader_count + eloop.event_count + 8)
		return 0;
	n = (HANDLE *)os_realloc(eloop.handles,
			     ...
			     void *eloop_data, void *user_data)
{
	...
	tmp = (struct eloop_sock *)os_realloc(eloop.readers,
			 ...
			 void *eloop_data, void *user_data)
{
	...
	tmp = (struct eloop_event *)os_realloc(eloop.events,
			  ...
			  void *user_data)
{
	...
	tmp = (struct eloop_signal *)os_realloc(eloop.signals,
