...
rfbInitSockets(rfbScreenInfoPtr rfbScreen)
{
	...
	return;
      ...
      rfbLog("Socket[%d] Listening for VNC connections on TCP port %d\n", rfbScreen->listenSock, rfbScreen->port);  
...
#ifdef LIBVNCSERVER_IPv6//解决armeabi库下accept失败的问题
...
//      chosen_listen_sock = rfbScreen->listen6Sock;
	...
	rfbLog("Socket[%d] Listening, accept(%d)...\n", rfbScreen->listenSock, chosen_listen_sock);
